    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img src="{{ asset('assets/logoPY.png') }}" alt="Logo"
                    class="h-8 w-auto max-w-none object-contain shrink-0" />
            </a>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <button
                ...
                @click="$store.theme.toggle()"> <svg class="hidden dark:block" width="20" height="20"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="currentColor" />
                </svg> <svg class="dark:hidden" width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
